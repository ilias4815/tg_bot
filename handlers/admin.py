...
async def make_changes_command(message:types.Message):
    ...
    await bot.send_message(message.from_user.id, "Приветствую хозяин", reply_markup=admin_bt.button_case_admin)
...
async def load_desription(message:types.Message, state:FSMContext):
    if message.from_user.id == ID:
        ...
        await FSMAdmin.next()
        await message.reply("Сколько готова отдать?")    
